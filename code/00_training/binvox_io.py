...
...     m1 = binvox_io.read_as_3d_array(f)
...
>>> m1.dims
[32, 32, 32]
>>> m1.scale
...
...     m2 = binvox_io.read_as_3d_array(f)
...
>>> m1.dims==m2.dims
True
>>> m1.scale==m2.scale
...
>>> with open('chair.binvox', 'rb') as f:
...     md = binvox_io.read_as_3d_array(f)
...
>>> with open('chair.binvox', 'rb') as f:
...     ms = binvox_io.read_as_coord_array(f)
...
>>> data_ds = binvox_io.dense_to_sparse(md.data)
>>> data_sd = binvox_io.sparse_to_dense(ms.data, 32)
